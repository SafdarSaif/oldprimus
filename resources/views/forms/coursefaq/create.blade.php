<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTitle">Add Course FAQ</h5>
...
@endphp
<form action="/add_coursefaq" method="post" id="add_banner" enctype="multipart/form-data" novalidate>
    @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-12">
                        <label for="basicInput">Select Courses</label>
