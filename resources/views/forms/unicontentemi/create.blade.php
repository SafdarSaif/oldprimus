<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTitle">Add Exam Pattern</h5>
...
@endphp
<form action="/add_uniemi" method="post" id="add_banner" enctype="multipart/form-data" novalidate>
    @csrf
