<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTitle">Assign College/University</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form id="assign_form_form" action="{{ route('assign.store') }}" method="POST" enctype="multipart/form-data">
    {{-- @method('PUT') --}}
    @csrf
    <input type="hidden" name="course_id" value="@php echo $course_id @endphp">
